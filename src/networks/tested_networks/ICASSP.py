...
def rhfcn(input_data, class_num=2, is_bn=True, activation_method="tanh", padding="SAME", is_max_pool=True):
    ...
    pool12 = pool_layer(bn11, height, width, height, width, name="global_max")
...
def rhfcn1_4(input_data, class_num=2, is_bn=True, activation_method="tanh", padding="SAME", is_max_pool=True):
    """
    Fully CNN for MP3 Steganalysis with Rich High-pass Filtering
    """
