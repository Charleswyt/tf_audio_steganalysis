...
"""
    function:
        ...
        tbafcn1_2: Remove the block-split shortcut module        
        tbafcn1_3: Quit replacing fully connected layers with fully convolutional layer
"""
...
def tbafcn1_1(input_data, class_num=2, is_bn=True, activation_method="tanh", padding="SAME", is_max_pool=True):
    ...
    fcn10 = fconv_layer(bn9, class_num, name="fcn10")
