## Dataset
The dataset can be downloaded from the [link](链接: https://pan.baidu.com/s/1QerWgcYiU37qzZ03vq3KGg), and we name it as **Audio Steganalysis Dataset, IIE (ASDIIE)**.

The ***extraction password*** is "**s6sm**".
